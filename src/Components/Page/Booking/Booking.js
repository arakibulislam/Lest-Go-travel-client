...
return (
    <div className='login all-margin'>
        <Container >
            ...
            <div className='row container justify-content-between my-5'>
                <div className='col-lg-8 col-12 container mx-auto'>
                    <div className='px-4'>
                        <h1>
                            {packegeDetails.name}
                        </h1>
                        ...
                        <div className=''>
                            <form onSubmit={handleSubmit(onSubmit)} className='d-flex flex-column '>
                                ...
                                <input className='btn btn-outline-dark py-3 w-25 mx-auto' type="submit" />
